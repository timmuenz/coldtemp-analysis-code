...
This repository contains the Stata (version 18) code used for the statistical analyses in the manuscript "Temperatures around conception affect metabolic health in adulthood" (Münz et al., Cpmmunications Medicine). The studyl inks UK Biobank data with derived ambient temperature exposure measures around the estimated date of conception. 
